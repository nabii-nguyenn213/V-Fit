...
final aiRecommendationRepositoryProvider =
  ...
  return AiRecommendationRepository(ref.watch(dioProvider));
});
  ...
  Future<Map<String, dynamic>> _post(
    ...
    try {
      ...
      final result = ApiResponseParser.unwrap(response, (json) {
        if (json is! Map) {
          throw const ApiException(message: 'Invalid AI response');
        }
        return Map<String, dynamic>.from(json);
      });
      print('[AI RECOMMENDATION] $path response=$result');
      return result;
